...
def get_default_params():
  default_params : list[tuple[str, str | bytes]] = [
    ...
    ("AutoCurveSpeedAggressiveness", "140"),
    ...
    ("RadarReactionFactor", "15"),     
    ("EnableRadarTracks", "0"),      
    ("HyundaiCameraSCC", "0"),
    ("CanfdHDA2", "0"),
    ("SoundVolumeAdjust", "30"),
    ("SoundVolumeAdjustEngage", "80"),
    ("TFollowGap1", "90"),
    ("TFollowGap2", "180"),
    ("TFollowGap3", "270"),
    ("TFollowGap4", "90"),
    ...
    ("UseLaneLineSpeedApply", "1"),    
    ("AdjustLaneOffset", "0"),    
    ("AdjustCurveOffset", "0"),    
    ("AdjustLaneTime", "8"),    
    ("MaxAngleFrames", "89"),       
    ("LateralTorqueCustom", "0"),       
    ("LateralTorqueAccelFactor", "1700"),       
    ("LateralTorqueFriction", "167"),
    ("CustomSteerMax", "300"),       
    ("CustomSteerDeltaUp", "10"),       
    ("CustomSteerDeltaDown", "12"),       
    ("SpeedFromPCM", "2"),       
    ("SteerActuatorDelay", "26"),       
    ("MaxTimeOffroadMin", "180"),
    ("HotspotOnBoot", "0"),
  ]
