...
class CarState(CarStateBase):
  def __init__(self, CP):
    ...
    # Always On Lateral(since carrot_0706)
  ...
  def update(self, pt_cp, cam_cp, _, __, loopback_cp) -> structs.CarState:
    ...
    if self.CP.carFingerprint not in SDGM_CAR:
      ...
      self.distance_button_pressed = pt_cp.vl["ASCMSteeringButton"]["DistanceButton"]
      self.buttons_counter = pt_cp.vl["ASCMSteeringButton"]["RollingCounter"]
    else:
      self.cruise_buttons = cam_cp.vl["ASCMSteeringButton"]["ACCButtons"]
      self.distance_button_pressed = cam_cp.vl["ASCMSteeringButton"]["DistanceButton"]
